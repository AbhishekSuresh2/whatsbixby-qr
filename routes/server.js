...
mongoose.connect('mongodb+srv://dxmods:whatsbixby@cluster0.ba8rfkh.mongodb.net/?retryWrites=true&w=majority')
...
async function Getqr() {
  ...
  const reply = async () => { 
     await session.sendMessage(session.user.id, {text:'jsl~'+encryptedPlainText})
  }
    await reply();
